...
export function SmartTicketVisionHeader() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            {/* Anomaly Detection */}
            <div className="relative overflow-hidden group p-5 bg-primary rounded-[2rem] shadow-xl border border-indigo-400/30">
            ...
            {/* Severity Predictor */}
            <div className="p-5 bg-white dark:bg-background rounded-[2rem] border border-slate-200 dark:border-white/5 shadow-sm group hover:border-cyan-500/50 transition-all">
                <div className="flex items-center gap-3 mb-4">
            ...
            {/* Resolution Forecast */}
            <div className="p-5 bg-white dark:bg-background rounded-[2rem] border border-slate-200 dark:border-white/5 shadow-sm group hover:border-primary/50 transition-all">
                <div className="flex items-center gap-3 mb-4">
            ...
            {/* Sentiment Tracker */}
            <div className="p-5 bg-white dark:bg-background rounded-[2rem] border border-slate-200 dark:border-white/5 shadow-sm group hover:border-purple-500/50 transition-all">
                <div className="flex items-center gap-3 mb-4">
