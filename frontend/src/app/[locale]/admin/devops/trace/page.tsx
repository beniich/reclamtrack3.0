                ...
                <div className="flex justify-between items-start">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <button type="button" onClick={() => toast('Fonctionnalité en cours de déploiement')}  className="text-slate-500 hover:text-slate-300">📋</button>
                        </div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <button type="button" onClick={() => toast('Fonctionnalité en cours de déploiement')}  className="bg-primary hover:bg-primary/90 text-white text-sm font-bold px-4 py-2 rounded-lg flex items-center gap-2">
