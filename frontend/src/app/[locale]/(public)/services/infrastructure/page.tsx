...
export default function InfrastructureLanding() {
    ...
    return (
        <div className="min-h-screen bg-brand-midnight text-white selection:bg-primary selection:text-white">
            {/* Hero Section */}
            <section className="relative pt-32 pb-20 overflow-hidden px-6 lg:px-20">
                <div className="absolute top-0 left-0 w-full h-full bg-primary/5 blur-[150px] -z-10"></div>

                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
                    <div className="flex-1 space-y-8 text-center lg:text-left">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-blue-400 text-[10px] font-black uppercase tracking-widest">
                        ...
                        <h1 className="text-5xl lg:text-8xl font-display font-black leading-tight tracking-tighter uppercase italic">
                            ...
                            <span className="text-primary not-italic">{t('heroTitle').split(' ').slice(2).join(' ')}</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 pt-4">
                            <Link href="/services/infrastructure/dashboard" className="w-full sm:w-auto bg-brand-orange text-white font-black px-10 py-5 rounded-2xl text-xs uppercase tracking-widest shadow-xl shadow-brand-orange/25 hover:bg-primary transition-all orange-glow transform hover:scale-105">
                                {t('ctaStart')}
                            </Link>
                    ...
                    <div className="flex-1 w-full max-w-2xl">
                        <div className="relative glass-card rounded-[3rem] p-8 border border-white/5 overflow-hidden group">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 blur-[80px] -z-10 group-hover:bg-primary/20 transition-all"></div>
                            ...
                            <div className="space-y-6 mb-10">
                                {[
                                    { label: 'CPU Usage', val: '24%', bar: 'w-1/4', color: 'bg-primary' },
                                    { label: 'RAM Ops', val: '12.4 GB', bar: 'w-1/2', color: 'bg-primary' },
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-white/5 border border-white/5 rounded-2xl p-6 hover:border-primary/30 transition-all">
                ...
                <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-10">
                    {[
                        ...
                        <div key={i} className="text-center group">
                            <div className="text-5xl font-black italic mb-2 group-hover:text-primary transition-all">{s.val}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        {[
                            ...
                            <div key={i} className={`glass-card rounded-[3rem] p-12 hover:-translate-y-4 transition-all duration-700 border ${f.accent}`}>
                                ...
                                <button type="button" className="text-[10px] font-black uppercase tracking-widest text-primary flex items-center gap-2 hover:gap-4 transition-all group">
                                    En savoir plus <ArrowRight className="text-sm" />
                                </button>
                            </div>
                        ))}
                    </div>
