...
export default function AssetDetailsPage() {
    ...
    return (
        <div className="p-6 space-y-8 bg-slate-50 dark:bg-background min-h-[calc(100vh-6rem)] relative overflow-hidden">
            {/* Background elements */}
            <div className="absolute -top-40 -left-40 w-96 h-96 bg-primary/10 dark:bg-primary/10 blur-[100px] rounded-full pointer-events-none"></div>

            {/* Back link & Actions */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                <Link href="/assets" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-primary dark:hover:text-primary transition-colors bg-white dark:bg-background border border-slate-200 dark:border-border-dark px-4 py-2 rounded-xl w-fit shadow-sm">
                    <ArrowLeft className="w-4 h-4" /> Retour au Registre
                </Link>

                <div className="flex gap-3">
                    <button type="button" className="px-5 py-3 rounded-xl bg-white dark:bg-background border border-slate-200 dark:border-border-dark text-[10px] font-black uppercase tracking-widest hover:border-indigo-300 dark:hover:border-primary/50 flex items-center gap-2 transition-all shadow-sm">
                        <PenTool className="w-4 h-4 text-slate-400" /> Signaler Panne
                    </button>
                    <button type="button" className="px-5 py-3 rounded-xl bg-primary dark:bg-primary text-white text-[10px] font-black uppercase tracking-widest hover:brightness-110 flex items-center gap-2 transition-all shadow-lg shadow-indigo-600/20 dark:shadow-orange-600/20">
            ...
            <div className="bg-white dark:bg-background rounded-[2.5rem] border border-slate-200 dark:border-border-dark overflow-hidden shadow-sm relative z-10">
                ...
                <div className="px-8 pb-8">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 -mt-12">
                        <div className="flex items-end gap-6">
                            <div className="size-24 rounded-[1.5rem] bg-white dark:bg-background border-4 border-white dark:border-slate-900 shadow-xl flex items-center justify-center p-1 z-10">
                                <div className="w-full h-full rounded-2xl bg-indigo-50 dark:bg-primary/10 border border-indigo-100 dark:border-primary/20 flex items-center justify-center text-primary dark:text-primary">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
                ...
                <div className="space-y-6">
                    <div className="bg-white dark:bg-background rounded-[2rem] border border-slate-200 dark:border-border-dark p-6 shadow-sm">
                        <h3 className="text-sm font-black uppercase italic tracking-tighter text-slate-900 dark:text-white flex items-center gap-2 mb-6">
                            <Box className="w-4 h-4 text-primary dark:text-primary" /> Localisation
                        </h3>
                    ...
                    <div className="bg-white dark:bg-background rounded-[2rem] border border-slate-200 dark:border-border-dark p-6 shadow-sm">
                        <h3 className="text-sm font-black uppercase italic tracking-tighter text-slate-900 dark:text-white flex items-center gap-2 mb-6">
                            <Settings className="w-4 h-4 text-primary dark:text-primary" /> Spécifications
                        </h3>
                        <div className="space-y-4">
                            {Object.entries(asset.specs).map(([key, value]) => (
                                <div key={key} className="flex items-center justify-between border-b border-slate-100 dark:border-border-dark pb-3 last:border-0 last:pb-0">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-primary dark:bg-primary rounded-[2rem] p-6 text-white shadow-lg relative overflow-hidden group">
                        ...
                        <div className="bg-white dark:bg-background rounded-[2rem] border border-slate-200 dark:border-border-dark p-6 shadow-sm">
                            ...
                            <div className="text-4xl font-black text-primary dark:text-primary italic tracking-tighter">98.5<span className="text-xl">%</span></div>
                        </div>
                    </div>

                    <div className="bg-white dark:bg-background rounded-[2.5rem] border border-slate-200 dark:border-border-dark flex flex-col shadow-sm h-[400px]">
                        <div className="p-6 border-b border-slate-100 dark:border-border-dark flex items-center justify-between">
                            <h3 className="text-sm font-black uppercase italic tracking-tighter text-slate-900 dark:text-white flex items-center gap-2">
                                <History className="w-4 h-4 text-primary dark:text-primary" /> Historique d'Interventions
                            </h3>
                        </div>
