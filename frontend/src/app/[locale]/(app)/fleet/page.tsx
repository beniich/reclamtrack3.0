...
import { Search, Bell, AlertTriangle, Plus, MoreVertical, Eye, Wrench, Trash } from 'lucide-react';
    ...
    return (
        <div className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white dark:bg-[#1c1c30] p-6 rounded-xl border border-slate-200 dark:border-border-dark shadow-sm">
                ...
                <div className="bg-white dark:bg-[#1c1c30] p-6 rounded-xl border border-slate-200 dark:border-border-dark shadow-sm ring-1 ring-amber-500/20">
                    <div className="flex items-center justify-between mb-4">
                ...
                <div className="bg-white dark:bg-[#1c1c30] p-6 rounded-xl border border-slate-200 dark:border-border-dark shadow-sm ring-1 ring-red-500/20">
                    <div className="flex items-center justify-between mb-4">
            ...
            <div className="bg-white dark:bg-[#1c1c30] rounded-xl border border-slate-200 dark:border-border-dark shadow-sm overflow-hidden" ref={menuRef}>
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-slate-50 dark:bg-[#242447]/50 text-slate-500 dark:text-[#9292c8] text-[11px] font-bold uppercase tracking-wider">
                            <th className="px-6 py-4 border-b border-slate-100 dark:border-border-dark">Vehicle Plate</th>
                            <th className="px-6 py-4 border-b border-slate-100 dark:border-border-dark">Model / Type</th>
                            <th className="px-6 py-4 border-b border-slate-100 dark:border-border-dark">Fuel Level</th>
                            <th className="px-6 py-4 border-b border-slate-100 dark:border-border-dark">Last Maintenance</th>
                            <th className="px-6 py-4 border-b border-slate-100 dark:border-border-dark">Mileage</th>
                    ...
                    <tbody className="text-sm divide-y divide-slate-100 dark:divide-slate-800">
                        {isLoading ? (
                            ...
                            vehicles.map(vehicle => {
                                ...
                                return (
                                    <tr key={vehicle._id} className="hover:bg-primary/5 dark:hover:bg-violet-500/15/40 transition-colors group">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className={`h-8 w-8 rounded flex items-center justify-center text-sm ${
                                                    ...
                                                    vehicle.status === 'in_use' ? 'bg-primary/10 text-primary' :
                                        ...
                                        <td className="px-6 py-4 text-right relative">
                                            <button type="button"
                                                ...
                                                className="p-1.5 rounded-lg hover:bg-primary/8 dark:hover:bg-slate-700 transition-colors"
                                            >
                                                    ...
                                                    {isStatusEdit ? (
                                                        <div className="p-2">
                                                            ...
                                                            {Object.entries(statusConfig).map(([key, val]) => (
                                                                <button type="button"
                                                                    ...
                                                                    className="w-full text-left px-3 py-2 text-sm font-medium hover:bg-primary/5 dark:hover:bg-violet-500/15 rounded-lg flex items-center gap-2 transition-colors"
                                                                >
                                                                    <span className={`w-2 h-2 rounded-full ${
                                                                        key === 'available' ? 'bg-emerald-500' :
                                                                        key === 'in_use' ? 'bg-primary' :
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                className="w-full text-left px-3 py-2 text-xs font-bold text-slate-400 hover:bg-primary/5 dark:hover:bg-violet-500/15 rounded-lg transition-colors"
                                                            >
                                                                ← Back
                                                            </button>
                                                        </div>
                                                        ...
                                                        <>
                                                            ...
                                                            <Link
                                                                ...
                                                                onClick={() => setOpenMenuId(null)}
                                                            >
                                                                <Wrench className="text-base text-amber-500" />
                ...
                <div className="px-6 py-4 bg-slate-50 dark:bg-[#242447]/30 border-t border-slate-100 dark:border-border-dark flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <button type="button"
                            ...
                            className="px-3 py-1 rounded border border-slate-200 dark:border-border-dark text-xs font-bold hover:bg-white dark:hover:bg-primary/20 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                            Previous
                        </button>
