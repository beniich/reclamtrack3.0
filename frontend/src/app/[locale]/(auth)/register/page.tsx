                    ...
                    <div className="text-center space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-500 dark:text-slate-400 text-sm">
                                Un email de vérification a été envoyé à <b>{email}</b>. Veuillez vérifier votre boîte de réception pour activer votre compte.
                            </p>
                        </div>
                        <div className="pt-2">
                            <Link href="/login" className="block w-full bg-primary hover:bg-primary/90 text-white font-semibold py-3 rounded-lg text-center transition-all">
