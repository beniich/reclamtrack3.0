    ...
    return (
        <div className="flex flex-col min-h-screen bg-white dark:bg-[#0a0a0f] text-slate-900 dark:text-slate-100 transition-colors duration-300 font-sans">
            ...
            <header className="sticky top-0 z-50 w-full bg-white/80 dark:bg-[#0a0a0f]/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
                <div className="max-w-7xl mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <Link href="#solutions" className="text-sm font-medium text-slate-500 hover:text-primary transition-colors">Solutions</Link>
                        <Link href="#pricing" className="text-sm font-medium text-slate-500 hover:text-primary transition-colors">Pricing</Link>
                        <Link href="/system-info" className="text-sm font-medium text-slate-500 hover:text-primary transition-colors">Resources</Link>
                    </nav>
            ...
            <main className="flex-1">
                ...
                <section className="relative pt-20 pb-20 lg:pt-32 lg:pb-40 overflow-hidden bg-[radial-gradient(circle_at_top_right,rgba(37,99,235,0.05),transparent_50%)]">
                    <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="flex flex-col gap-8 max-w-xl animate-in fade-in slide-in-from-left-8 duration-1000">
                            ...
                            <h1 className="text-6xl lg:text-8xl font-black leading-[0.95] tracking-tight text-slate-900 dark:text-white">
                                Efficient <br />
                                Municipal <br />
                                Service <br />
                            ...
                            {/* Stats Info Cards like in the screenshot */}
                            <div className="pt-12 grid grid-cols-3 gap-8">
                                <div className="flex flex-col border-l-2 border-slate-100 dark:border-slate-800 pl-6">
                                    ...
                                    <span className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mt-1">Municipalities</span>
                                </div>
                                <div className="flex flex-col border-l-2 border-slate-100 dark:border-slate-800 pl-6">
                                    <span className="text-4xl font-black text-slate-900 dark:text-white">98%</span>
                                    <span className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mt-1">Resolution Rate</span>
                                </div>
                                <div className="flex flex-col border-l-2 border-slate-100 dark:border-slate-800 pl-6">
                                    <span className="text-4xl font-black text-slate-900 dark:text-white">24/7</span>
                                    <span className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mt-1">Live Support</span>
                                </div>
                            </div>
                        </div>

                        {/* Hero Mockup - Clean UI style like screenshot 2 */}
                        <div className="relative group animate-in fade-in zoom-in duration-1000 delay-200">
                            ...
                            <div className="relative bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] dark:shadow-none overflow-hidden aspect-[4/3] p-6 lg:p-8">
                                ...
                                <div className="flex-1 h-[240px] bg-slate-50 dark:bg-slate-800/50 rounded-3xl border border-slate-100 dark:border-slate-700 relative overflow-hidden group-hover:scale-[1.02] transition-transform duration-700">
                                    ...
                                    {/* Small Info Widget hovering on mockup */}
                ...
                <section id="features" className="bg-white dark:bg-[#0a0a0f] py-32">
                    <div className="max-w-7xl mx-auto px-6 lg:px-10">
                        <div className="text-center max-w-3xl mx-auto mb-20">
                            <h2 className="text-primary font-black text-[10px] tracking-[0.3em] uppercase mb-4">Core Capabilities</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                            {[
                                { title: 'Real-time Tracking', icon: 'location_on', color: 'blue', desc: 'Monitor every complaint from submission to resolution with live GPS and status updates. Never lose sight of progress.' },
                                { title: 'Team Coordination', icon: 'groups', color: 'blue', desc: 'Dispatch work orders instantly to field crews and sync communications in a single unified dashboard for all departments.' },
                                { title: 'Smart Reporting', icon: 'monitoring', color: 'blue', desc: 'Generate data-driven insights and compliance reports with one click to optimize resource allocation and budget planning.' }
                            ].map((f, i) => (
                ...
                {/* Call to Action Banner - Modern Blue Gradient */}
                    ...
                    <div className="max-w-7xl mx-auto px-6 lg:px-10">
                        <div className="relative bg-gradient-to-br from-primary to-blue-700 rounded-[3rem] p-12 lg:p-20 overflow-hidden flex flex-col items-center justify-center text-center gap-10">
                            ...
                            <div className="relative z-10 max-w-2xl">
                                <h2 className="text-4xl lg:text-6xl font-black text-white mb-6 leading-tight">Ready to modernize your services?</h2>
                                <p className="text-blue-100 text-xl font-medium opacity-90">Join 50+ municipalities already using CMS to drive efficiency.</p>
                            </div>
            ...
            {/* Premium Footer like Screenshot 2 */}
            <footer className="bg-white dark:bg-[#0a0a0f] border-t border-slate-200 dark:border-slate-800 pt-24 pb-12">
                <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-2 lg:grid-cols-6 gap-16">
                    ...
                    <div>
                        <h5 className="font-black text-[11px] uppercase tracking-widest mb-8 text-slate-900 dark:text-white">Product</h5>
                    ...
                    <div>
                        <h5 className="font-black text-[11px] uppercase tracking-widest mb-8 text-slate-900 dark:text-white">Company</h5>
                        <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
                    ...
                    <div>
                        <h5 className="font-black text-[11px] uppercase tracking-widest mb-8 text-slate-900 dark:text-white">Support</h5>
                        <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
                    ...
                    <div>
                        <h5 className="font-black text-[11px] uppercase tracking-widest mb-8 text-slate-900 dark:text-white">Legal</h5>
                        <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-10 mt-24 pt-8 border-t border-slate-100 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-8">
                    <p className="text-sm font-medium text-slate-400">© 2024 CMS Municipal Solutions. All rights reserved.</p>
