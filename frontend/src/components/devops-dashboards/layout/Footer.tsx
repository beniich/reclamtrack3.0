...
export const Footer = () => (
    <footer className="fixed bottom-0 left-0 right-0 bg-white/80 dark:bg-background/80 backdrop-blur-md border-t border-slate-200 dark:border-border-dark px-6 py-2 z-40 hidden md:flex justify-between items-center text-xs font-bold text-slate-500 uppercase tracking-wider">
