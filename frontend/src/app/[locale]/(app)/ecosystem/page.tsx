    ...
    <div className="min-h-screen bg-slate-50 text-slate-950 p-8 md:p-14 overflow-hidden relative">
      ...
      >
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 text-slate-900">
          Portail <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Multi-Projets</span>
        </h1>
        ...
        <AnimatePresence>
          {projects.map((project, index) => (
            <motion.div
              ...
              className={`relative group rounded-3xl border border-slate-200 bg-white p-6 shadow-sm overflow-hidden transition-all duration-300 ${project.bgHover} hover:border-indigo-300 hover:shadow-xl hover:shadow-indigo-500/5`}
            >
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="px-3 py-1 bg-emerald-50 border border-emerald-100 rounded-full flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest">{project.status}</span>
                  </div>
                </div>
      ...
      >
        <div className="rounded-3xl border border-indigo-100 bg-white p-8 md:p-12 shadow-xl shadow-indigo-500/5 flex flex-col md:flex-row items-center justify-between overflow-hidden relative">
          ...
          <div className="relative z-10 md:w-2/3 mb-6 md:mb-0">
            <h2 className="text-2xl font-bold text-slate-900 mb-2">Besoin d'une solution sur mesure ?</h2>
