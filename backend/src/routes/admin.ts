...
router.get('/audit', auth, adminOnly, (req: Request, res: Response) => {
    res.json({
        success: true,
        data: [
            { id: 1, action: 'LOGIN', user: 'admin@reclamtrack.com', ip: '192.168.1.1', time: '2025-02-11 08:30' },
            { id: 2, action: 'CREATE_USER', user: 'admin@reclamtrack.com', target: 'tech2@reclamtrack.com', time: '2025-02-10 14:00' },
