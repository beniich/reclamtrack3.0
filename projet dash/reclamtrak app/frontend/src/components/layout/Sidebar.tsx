    ...
    const menuGroups: MenuGroup[] = useMemo(() => [
        {
            ...
            items: [
                ...
                { label: t('gmaoReports'),    href: '/reports/maintenance', icon: FileBarChart, badge: 'KPI', badgeColor: 'bg-indigo-500' },
            ],
        },
        {
            title: t('ops'),
            items: [
                ...
                { label: t('mroStore'),    href: '/inventory/mro',      icon: ArchiveRestore, badge: 'Stock', badgeColor: 'bg-blue-500' },
                { label: t('assets'),      href: '/assets',             icon: Box, badge: 'GMAO', badgeColor: 'bg-emerald-500' },
                { label: t('workOrders'),  href: '/work-orders',        icon: Wrench, badge: 'OT', badgeColor: 'bg-red-500' },
                { label: t('pmMaintenance'), href: '/maintenance',      icon: Calendar, badge: 'PM', badgeColor: 'bg-amber-500' },
