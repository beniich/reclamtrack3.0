...
export default function SecurityDashboard() {
    ...
    return (
        <div className="flex h-[calc(100vh-4rem)] overflow-hidden bg-slate-50 dark:bg-background font-sans text-slate-900 dark:text-slate-100">
            {/* Sidebar */}
            <aside className="w-64 flex-shrink-0 flex flex-col border-r border-slate-200 dark:border-border-dark bg-white dark:bg-background">
                ...
                <nav className="flex-1 px-4 space-y-1 overflow-y-auto custom-scrollbar">
                    ...
                    <a href="#" className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-primary/8 dark:hover:bg-violet-500/15 transition-colors">
                ...
                <div className="p-4 border-t border-slate-200 dark:border-border-dark">
                    <div className="bg-slate-100 dark:bg-background p-3 rounded-xl flex items-center gap-3">
                        <div className="size-8 rounded-full bg-primary/20 flex items-center justify-center text-primary font-bold text-xs">JD</div>
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
                {/* Top Navbar */}
                <header className="h-16 flex items-center justify-between px-8 border-b border-slate-200 dark:border-border-dark bg-white/80 dark:bg-background/80 backdrop-blur-md sticky top-0 z-10">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex bg-slate-100 dark:bg-background p-1 rounded-lg">
                            <Button variant="primary" className="px-3 py-1 text-xs font-semibold rounded-md transition-colors bg-white dark:bg-primary text-slate-900 dark:text-white shadow-sm">Prod</Button>
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white dark:bg-background p-6 rounded-2xl border border-slate-200 dark:border-border-dark shadow-sm">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="bg-white dark:bg-background p-6 rounded-2xl border border-slate-200 dark:border-border-dark shadow-sm">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <div className="flex items-center gap-4 text-xs">
                                    <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-primary"></span> Success</div>
                                    <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-rose-500"></span> Failures</div>
                                </div>
                            </div>
                            <div className="h-64 flex items-end gap-1 relative group bg-slate-50 dark:bg-background/50 rounded-lg overflow-hidden">
                                {/* Simulated Chart */}
                        ...
                        <div className="bg-white dark:bg-background p-6 rounded-2xl border border-slate-200 dark:border-border-dark shadow-sm">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <select className="text-xs bg-slate-50 dark:bg-background border border-slate-200 dark:border-border-dark rounded-md py-1 px-2">
                            ...
                            <div className="h-64 flex items-end gap-2 px-2">
                                ...
                                <div className="flex-1 bg-primary/20 hover:bg-primary transition-all rounded-t-sm" style={{ height: '60%' }}></div>
                                <div className="flex-1 bg-primary/20 hover:bg-primary transition-all rounded-t-sm" style={{ height: '35%' }}></div>
                                <div className="flex-1 bg-primary/20 hover:bg-primary transition-all rounded-t-sm" style={{ height: '80%' }}></div>
                                ...
                                <div className="flex-1 bg-primary/20 hover:bg-primary transition-all rounded-t-sm" style={{ height: '45%' }}></div>
                                <div className="flex-1 bg-primary/20 hover:bg-primary transition-all rounded-t-sm" style={{ height: '30%' }}></div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {auditLoading ? (
                                Array(6).fill(0).map((_, i) => (
                                    <div key={i} className="h-24 bg-slate-50 dark:bg-background/50 animate-pulse rounded-xl"></div>
                                ))
                            ) : (
                                securityChecks.map((check) => (
                                    <div key={check.id} className="p-4 rounded-xl border border-slate-100 dark:border-border-dark bg-slate-50/50 dark:bg-background/30 flex gap-4">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            {check.recommendation && (
                                                <p className="text-[10px] text-primary font-medium mt-1 truncate">💡 {check.recommendation}</p>
                                            )}
                                        </div>
                                    </div>
                                ))
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="bg-white dark:bg-background p-6 rounded-2xl border border-slate-200 dark:border-border-dark shadow-sm">
                            ...
                            <div className="flex justify-center relative py-4">
                                {/* Fake Donut Chart */}
                                <div className="size-40 rounded-full border-[12px] border-slate-100 dark:border-border-dark flex items-center justify-center relative">
                                    <div className="absolute inset-[-12px] rounded-full border-[12px] border-primary border-r-transparent border-b-transparent rotate-12"></div>
                            ...
                            <div className="mt-6 space-y-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2"><span className="size-2 rounded-full bg-primary"></span> <span className="text-xs">2xx OK</span></div>
                        ...
                        <div className="lg:col-span-2 bg-white dark:bg-background rounded-2xl border border-slate-200 dark:border-border-dark shadow-sm overflow-hidden">
                            <div className="p-6 border-b border-slate-200 dark:border-border-dark flex justify-between items-center">
                                ...
                                <Button variant="ghost" className="text-xs text-primary font-medium">View all</Button>
                            </div>
                            <table className="w-full text-left text-sm">
                                <thead>
                                    <tr className="text-slate-500 border-b border-slate-100 dark:border-border-dark">
                    ...
                    {/* Live Log Stream */}
                    <div className="bg-white dark:bg-background rounded-2xl border border-slate-200 dark:border-border-dark shadow-sm overflow-hidden flex flex-col h-96">
                        <div className="p-4 border-b border-slate-200 dark:border-border-dark flex items-center justify-between bg-slate-50 dark:bg-background/50">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex gap-2">
                                    <span className="px-2 py-0.5 rounded bg-primary/10 text-primary text-[10px] font-bold cursor-pointer">INFO</span>
                        ...
                        <div className="flex-1 bg-[#0b101a] p-4 font-mono text-xs overflow-y-auto custom-scrollbar space-y-1">
                            {logsLoading ? (
                                ...
                                auditLogs.map((log: any, idx: number) => (
                                    <div key={idx} className={`p-1 border-l-2 ${log.action === 'ERROR' ? 'border-rose-500 bg-rose-500/5' : log.action === 'WARN' ? 'border-amber-500' : 'border-emerald-500'} flex gap-4 hover:bg-primary/10 transition-colors`}>
                                        ...
                                        <span className="text-slate-300">User <span className="text-primary">{log.userId || log.user}</span> executed <span className="text-blue-400">{log.action}</span> on {log.targetType || 'system'}</span>
                                    </div>
                                ))
                            ) : (
