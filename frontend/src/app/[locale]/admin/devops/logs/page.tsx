...
export default function LogSenseDashboard() {
    return (
        <div className="flex h-[calc(100vh-4rem)] w-full overflow-hidden bg-[#0a0e14] text-slate-300 font-mono text-xs">
            ...
            <aside className="w-64 flex-shrink-0 flex flex-col border-r border-border-dark bg-[#0d1117]">
                <div className="flex items-center gap-2 p-4 border-b border-border-dark text-primary">
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-3 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <select className="w-full bg-[#161b22] border border-slate-700/50 rounded p-2 text-slate-300 focus:outline-none focus:border-primary hover:border-slate-600 transition-colors">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="space-y-1">
                            <label className="flex items-center gap-2 px-2 py-1.5 rounded hover:bg-violet-500/15/50 cursor-pointer group">
                            ...
                            <label className="flex items-center gap-2 px-2 py-1.5 rounded hover:bg-violet-500/15/50 cursor-pointer group">
                                <input type="checkbox" className="rounded border-slate-700 bg-[#161b22] text-primary focus:ring-0 focus:ring-offset-0" defaultChecked />
                                <span className="text-primary font-bold group-hover:text-blue-400">INFO</span>
            ...
            <main className="flex-1 flex flex-col min-w-0">
                {/* Search Bar Header */}
                <header className="flex flex-col border-b border-border-dark bg-[#0d1117] p-2 gap-2">
                    {/* Search Input Area */}
                    <div className="flex items-center gap-2 w-full">
                        <div className="flex-1 relative">
                            ...
                            <input
                                type="text"
                                className="w-full bg-[#0a0e14] border border-slate-700 text-slate-200 pl-10 pr-12 py-2 rounded focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary placeholder:text-slate-600 text-sm font-mono"
                    ...
                    <div className="h-12 w-full bg-[#0a0e14] border border-border-dark rounded relative overflow-hidden flex items-end px-1 gap-px">
                        {/* Simulated Histogram Bars */}
                        <div className="flex-1 bg-slate-800 hover:bg-primary h-2/5 rounded-t-sm transition-colors"></div>
                        <div className="flex-1 bg-slate-800 hover:bg-primary h-1/5 rounded-t-sm transition-colors"></div>
                        <div className="flex-1 bg-slate-800 hover:bg-primary h-3/5 rounded-t-sm transition-colors"></div>
                        <div className="flex-1 bg-slate-800 hover:bg-primary h-full rounded-t-sm transition-colors"></div>
                        ...
                        <div className="flex-1 bg-slate-800 hover:bg-primary h-2/5 rounded-t-sm transition-colors"></div>
                        <div className="flex-1 bg-slate-800 hover:bg-primary h-1/4 rounded-t-sm transition-colors"></div>
                        <div className="flex-1 bg-slate-800 hover:bg-primary h-1/2 rounded-t-sm transition-colors"></div>
                        <div className="flex-1 bg-slate-800 hover:bg-primary h-3/4 rounded-t-sm transition-colors"></div>
                        <div className="flex-1 bg-slate-800 hover:bg-primary h-1/5 rounded-t-sm transition-colors"></div>
                ...
                <div className="flex-1 overflow-auto custom-scrollbar bg-[#0a0e14]">
                    <table className="w-full text-left border-collapse table-fixed">
                        <thead className="bg-[#161b22] sticky top-0 z-10 text-slate-500 font-semibold border-b border-border-dark">
                            <tr>
                                <th className="w-10 px-2 py-1 text-center border-r border-border-dark">
                                    <input type="checkbox" className="rounded bg-slate-800 border-slate-700" />
                                </th>
                                <th className="w-32 px-4 py-2 border-r border-border-dark text-[10px] uppercase tracking-wider hover:text-slate-300 cursor-pointer">Timestamp</th>
                                <th className="w-20 px-4 py-2 border-r border-border-dark text-[10px] uppercase tracking-wider hover:text-slate-300 cursor-pointer">Level</th>
                                <th className="w-32 px-4 py-2 border-r border-border-dark text-[10px] uppercase tracking-wider hover:text-slate-300 cursor-pointer">Service</th>
                        ...
                        <tbody className="text-slate-300 divide-y divide-slate-800/50">
                            {/* Log Entry 1: Error */}
                            <tr className="hover:bg-violet-500/15/30 group">
                                <td className="px-2 py-1.5 text-center border-r border-border-dark/50 bg-[#0a0e14] group-hover:bg-[#0d1620]">
                                    <ChevronRight className="size-3 text-slate-600" />
                                </td>
                                <td className="px-4 py-1.5 border-r border-border-dark/50 font-mono text-slate-500 whitespace-nowrap">Oct 24 14:22:10.452</td>
                                <td className="px-4 py-1.5 border-r border-border-dark/50 font-bold text-rose-500">ERROR</td>
                                <td className="px-4 py-1.5 border-r border-border-dark/50 text-slate-400">auth-service</td>
                            ...
                            <tr className="hover:bg-violet-500/15/30 group">
                                ...
                                <td className="px-4 py-1.5 border-r border-border-dark/50 font-mono text-slate-500 whitespace-nowrap">Oct 24 14:22:10.110</td>
                                <td className="px-4 py-1.5 border-r border-border-dark/50 font-bold text-primary">INFO</td>
                                <td className="px-4 py-1.5 border-r border-border-dark/50 text-slate-400">api-gateway</td>
                            ...
                            {[...Array(15)].map((_, i) => (
                                <tr key={i} className="hover:bg-violet-500/15/30 group">
                                    <td className="px-2 py-1.5 text-center border-r border-border-dark/50 bg-[#0a0e14] group-hover:bg-[#0d1620]">
                                        <ChevronRight className="size-3 text-slate-600" />
                                    </td>
                                    <td className="px-4 py-1.5 border-r border-border-dark/50 font-mono text-slate-500 whitespace-nowrap">Oct 24 14:22:0{9 - (i % 9)}.00{i}</td>
                                    <td className="px-4 py-1.5 border-r border-border-dark/50 font-bold text-primary">INFO</td>
                                    <td className="px-4 py-1.5 border-r border-border-dark/50 text-slate-400">worker-node-{i % 5}</td>
                ...
                {/* Footer / Pagination */}
                <footer className="h-8 border-t border-border-dark bg-[#0d1117] flex items-center justify-between px-4 text-[10px] text-slate-500">
