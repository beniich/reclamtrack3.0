        ...
        <section className="relative overflow-hidden bg-white rounded-[2.5rem] border border-slate-200 p-12 shadow-sm">
            ...
            <div className="max-w-6xl mx-auto space-y-16">
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-12 left-0 w-full h-px bg-slate-100 hidden lg:block"></div>
                        ...
                        {lifecycleSteps.map((step, idx) => (
                            <div key={idx} className="flex flex-col items-center text-center space-y-6 group">
                                ...
                                <div className={cn(
                                    ...
                                    step.color === 'indigo' && "group-hover:shadow-[0_0_30px_rgba(79,70,229,0.1)] group-hover:border-indigo-400/50",
                                    step.color === 'blue' && "group-hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] group-hover:border-blue-400/50",
                                    step.color === 'purple' && "group-hover:shadow-[0_0_30px_rgba(168,85,247,0.1)] group-hover:border-purple-400/50",
                                    step.color === 'cyan' && "group-hover:shadow-[0_0_30px_rgba(34,211,238,0.1)] group-hover:border-cyan-400/50",
                                    step.color === 'emerald' && "group-hover:shadow-[0_0_30px_rgba(16,185,129,0.1)] group-hover:border-emerald-400/50"
                                )}>
                                    ...
                                    <div className="absolute inset-2 rounded-full border border-slate-200/50 opacity-50"></div>
                                </div>
