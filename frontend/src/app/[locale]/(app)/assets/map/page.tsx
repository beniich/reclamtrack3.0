...
export default function AssetMapPage() {
    return (
        <div className="p-6 space-y-8 bg-slate-50 dark:bg-background min-h-[calc(100vh-6rem)] relative overflow-hidden flex flex-col">
            {/* Ambient glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/5 dark:bg-primary/5 blur-[120px] -z-10 pointer-events-none rounded-full"></div>

            {/* Header */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                <div className="flex items-center gap-3">
                    <div className="p-3 bg-white dark:bg-background text-primary dark:text-primary rounded-2xl shadow-sm border border-slate-200 dark:border-border-dark">
                        <Map className="w-6 h-6" />
                    </div>
                    <div>
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white uppercase italic tracking-tighter">
                            Cartographie <span className="text-primary dark:text-primary not-italic">GMAO</span>
                        </h2>
            ...
            <div className="flex-1 bg-white dark:bg-background rounded-[2.5rem] border border-slate-200 dark:border-border-dark shadow-sm relative overflow-hidden group">
                ...
                <div className="absolute top-[30%] left-[40%] animate-pulse z-10 cursor-pointer group/pin">
                    <div className="size-4 bg-emerald-500 rounded-full border-2 border-white dark:border-slate-900 shadow-lg relative">
                        <div className="absolute top-6 left-1/2 -translate-x-1/2 opacity-0 group-hover/pin:opacity-100 transition-opacity bg-surface-dark dark:bg-white text-white dark:text-slate-900 text-[10px] font-bold px-3 py-1.5 rounded-lg whitespace-nowrap z-20 shadow-xl">
                ...
                <div className="absolute inset-0 bg-slate-50/50 dark:bg-background/50 backdrop-blur-sm flex flex-col items-center justify-center z-0">
                    <Map className="size-20 text-primary/20 dark:text-primary/20 mb-6" />
                    ...
                    <button type="button" className="px-6 py-3 rounded-2xl bg-surface-dark dark:bg-white text-white dark:text-slate-900 text-[10px] font-black uppercase tracking-widest hover:scale-105 transition-transform flex items-center gap-2 shadow-xl">
