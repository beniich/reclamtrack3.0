...
import { ChevronRight, Edit2, ArrowUp, ArrowDown, TrendingUp, MessageSquare, MapPin, ArrowRight } from 'lucide-react';
        ...
        <div className="flex flex-col max-w-[1200px] mx-auto gap-8 p-6 lg:px-40 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-2 rounded-xl p-6 bg-white dark:bg-background border border-slate-200 dark:border-border-dark shadow-sm">
                    ...
                    <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-primary text-sm font-bold flex items-center">
                            <ArrowDown className="text-xs" /> 0.5h
                        </span>
                    </div>
                    <div className="w-full bg-slate-100 dark:bg-slate-800 h-2 rounded-full mt-2 overflow-hidden">
                ...
                <div className="flex flex-col gap-2 rounded-xl p-6 bg-white dark:bg-background border border-slate-200 dark:border-border-dark shadow-sm">
                    ...
                    <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-emerald-500 text-sm font-bold flex items-center">
                            <TrendingUp className="text-xs" /> 12%
                        </span>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div className="lg:col-span-4 flex flex-col gap-6">
                    <div className="bg-white dark:bg-background rounded-xl border border-slate-200 dark:border-border-dark overflow-hidden">
                        ...
                        <div className="p-4 flex flex-col gap-4">
                            <div className="flex items-center gap-4 p-2 rounded-lg hover:bg-primary/5 dark:hover:bg-violet-500/15 transition-colors group">
                        ...
                        <Button variant="secondary" className="w-full py-4 text-center text-slate-500 dark:text-slate-400 text-sm font-medium hover:bg-primary/5 dark:hover:bg-violet-500/15 border-t border-slate-100 dark:border-border-dark">View Full Contact Details</Button>
                    </div>
                    <div className="bg-white dark:bg-background rounded-xl border border-slate-200 dark:border-border-dark p-6">
                ...
                <div className="lg:col-span-8 flex flex-col gap-6">
                    <div className="bg-white dark:bg-background rounded-xl border border-slate-200 dark:border-border-dark overflow-hidden flex flex-col h-full">
                        ...
                        <div className="p-6 overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-wider border-b border-slate-100 dark:border-border-dark">
                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                    <tr className="group hover:bg-primary/5 dark:hover:bg-violet-500/10 transition-colors">
                                        <td className="py-4">
                                    ...
                                    <tr className="group hover:bg-primary/5 dark:hover:bg-violet-500/10 transition-colors">
                                        ...
                                        <td className="py-4">
                                            <span className="px-2 py-0.5 bg-blue-100 text-primary dark:bg-blue-900/30 dark:text-blue-400 text-[10px] font-black uppercase rounded">Normal</span>
                                        </td>
                                        <td className="py-4 text-right">
                                    ...
                                    <tr className="group hover:bg-primary/5 dark:hover:bg-violet-500/10 transition-colors">
                                        ...
                                        <td className="py-4">
                                            <span className="px-2 py-0.5 bg-orange-100 text-primary dark:bg-orange-900/30 dark:text-orange-400 text-[10px] font-black uppercase rounded">High</span>
                                        </td>
                                        <td className="py-4 text-right">
                                            <span className="inline-flex items-center gap-1.5 text-emerald-500 text-sm font-medium">
                                                <span className="h-2 w-2 bg-emerald-500 rounded-full"></span> Completed
                        ...
                        <div className="mt-auto p-4 border-t border-slate-100 dark:border-border-dark flex justify-center">
