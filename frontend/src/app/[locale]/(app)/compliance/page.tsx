        ...
        <div className="min-h-[calc(100vh-64px)] bg-slate-50 dark:bg-[#0a0a14] font-display overflow-x-hidden p-4 lg:p-10 space-y-10">
            ...
            <div className="bg-white dark:bg-background rounded-[32px] border border-slate-200 dark:border-border-dark p-8 shadow-lg">
                <div className="flex items-center justify-between mb-8">
                     ...
                     <Button variant="ghost" className="text-[10px] font-black text-red-500 uppercase hover:underline">Revoke All</Button>
                </div>
            ...
            <div className="bg-white dark:bg-background rounded-[32px] border border-slate-200 dark:border-border-dark p-8 shadow-lg">
                <div className="flex items-center justify-between mb-8">
                     ...
                     <Button variant="ghost" className="text-[10px] font-black text-primary uppercase hover:underline">View All History</Button>
                </div>
                        ...
                        <tbody className="divide-y divide-slate-50 dark:divide-slate-800/50 text-[11px] font-bold">
                            {events?.map((event: any) => (
                                <tr key={event._id} className="group hover:bg-primary/5/50 dark:hover:bg-violet-500/15/20 transition-colors">
                                    ...
                                    <td className="py-4">
                                        <button type="button" className="p-2 bg-slate-100 dark:bg-slate-800 rounded-lg hover:text-primary transition-colors">
                                            <Eye className="w-4 h-4" />
                                        </button>
                                    </td>
                                </tr>
