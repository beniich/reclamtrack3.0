...
import { BarChart, X, Users, AlertTriangle, AlertCircle, History, CheckCircle, Info } from 'lucide-react';

export default function ConflictResolutionPage() {
    return (
        <div className="flex h-full flex-col bg-background-dark text-slate-100 font-sans antialiased">
            {/* Header */}
            <header className="bg-surface-dark border-b border-border-dark h-16 flex items-center justify-between px-6 shrink-0 z-30">
                <div className="flex items-center gap-4">
                    <div className="bg-amber-500 p-1.5 rounded-lg flex items-center justify-center shadow-lg shadow-amber-500/20">
                        <BarChart className="text-slate-900" />
                    </div>
                    <div>
                ...
                <div className="flex items-center gap-6">
                    ...
                    <button type="button" className="bg-primary hover:bg-primary text-white px-6 py-2.5 rounded-xl text-sm font-bold shadow-lg shadow-blue-500/20 transition-all flex items-center gap-2">
                        <span className="material-symbols-outlined text-sm">done_all</span>
                        Resolve All Issues
                    </button>
                    <Link href="/roster-scheduler" className="p-2 hover:bg-violet-500/15 rounded-lg text-slate-400 transition-colors">
                        <X />
                    </Link>
                </div>
            </header>
            ...
            <main className="flex-1 flex overflow-hidden">
                <div className="flex-1 flex flex-col min-w-0">
                    <div className="flex-1 flex bg-background-dark p-6 gap-6 overflow-hidden">
                        {/* Center Content */}
                        <div className="flex-1 flex flex-col gap-6 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800 pr-2">
                            ...
                            <div className="flex items-center justify-between px-2">
                                ...
                                <div className="bg-surface-dark px-3 py-1.5 rounded-lg border border-border-dark">
                                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-tighter">Conflict ID: </span>
                                    <span className="text-xs font-mono text-primary font-bold">#DB-4920</span>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                                {/* Source Context */}
                                <div className="bg-surface-dark rounded-2xl border border-border-dark flex flex-col overflow-hidden">
                                    <div className="p-4 border-b border-border-dark bg-slate-800/20 flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                    ...
                                    <div className="p-6 space-y-4">
                                        ...
                                        <div className="p-4 rounded-xl border-2 border-red-500/30 bg-red-500/5 relative">
                                            ...
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <AlertCircle className="text-red-400 text-sm" />
                                            </div>
                            ...
                            <div className="bg-surface-dark rounded-2xl border border-border-dark p-6">
                                ...
                                <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                                    <div className="xl:col-span-2 space-y-3">
                                        <div className="flex items-start gap-4 p-4 rounded-xl bg-slate-800/50 border border-slate-700/50 hover:border-primary/50 transition-colors cursor-pointer group">
                                            <div className="bg-emerald-500/10 text-emerald-500 p-2 rounded-lg">
                                                <span className="material-symbols-outlined">swap_horiz</span>
                                            </div>
                                            <div className="flex-1">
                                                <p className="text-sm font-semibold text-slate-200 group-hover:text-primary transition-colors">Shift Resource Assignment</p>
                                            ...
                                            <Button variant="primary" className="bg-primary/10 text-primary px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider hover:bg-primary hover:text-white transition-all">Apply Fix</Button>
                                        </div>
                        ...
                        <aside className="w-80 bg-surface-dark border border-border-dark rounded-2xl flex flex-col shrink-0 overflow-hidden shadow-2xl">
                            <div className="p-4 border-b border-border-dark bg-slate-800/40">
                                <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                                    <History className="text-sm" /> Conflict Queue
                                </h3>
                            </div>

                            <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800 p-2 space-y-2">
                                <div className="p-3 rounded-xl bg-primary/10 border-2 border-primary/40 relative">
                                    <div className="flex justify-between items-start mb-2">
                                        <span className="text-[10px] font-bold text-primary uppercase">Conflict 01</span>
                            ...
                            <div className="p-4 bg-background-dark border-t border-border-dark">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="w-full h-1 bg-slate-800 rounded-full overflow-hidden">
                                        <div className="w-[98%] h-full bg-primary shadow-[0_0_8px_rgba(59,130,246,0.5)]"></div>
                                    </div>
                                </div>
                            </div>
                        </aside>
            ...
            {/* Footer */}
            <footer className="h-14 border-t border-border-dark bg-surface-dark flex items-center justify-between px-6 shrink-0 z-30">
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2">
                        <Info className="text-slate-500 text-sm" />
