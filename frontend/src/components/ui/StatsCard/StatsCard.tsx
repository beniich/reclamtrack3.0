...
export function StatsCard({
    ...
    return (
        <div
            className={cn(
                "bg-white rounded-[2rem] p-6 border border-slate-200 shadow-sm transition-all duration-500 hover:shadow-xl hover:shadow-indigo-500/5 hover:-translate-y-1 group",
                className
            )}
            style={style}
        >
            <div className="flex items-center gap-5">
                ...
                <div className="flex-1 overflow-hidden">
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1 truncate">
                        {title}
                    </p>
