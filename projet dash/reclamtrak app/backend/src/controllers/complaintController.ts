...
export class ComplaintController {
  ...
  async create(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const complaint = await complaintService.createComplaint(complaintData, (req as any).tenantConn);
  ...
  async delete(req: Request, res: Response, next: NextFunction) {
    try {
      await complaintService.deleteComplaint(req.params.id as string, (req as any).organizationId, (req as any).tenantConn);
  ...
  async getStats(req: Request, res: Response, next: NextFunction) {
    try {
      const stats = await complaintService.getComplaintStats((req as any).organizationId, (req as any).tenantConn);
